...
SWEP.PrintName		= "Breaching Charge TTT"
SWEP.Author			= "Sevan Buechele"
SWEP.Contact		= "STEAM_0:1:65313765"
SWEP.Spawnable		= false
SWEP.AdminOnly		= false
SWEP.ViewModel		= Vmtype
SWEP.WorldModel		= "models/minic23/csgo/breach_charge_detonator.mdl"
SWEP.ViewModelFOV	= 60
SWEP.UseHands		= true
AddCSLuaFile()

/*|Weapon Configuration TTT|*/
SWEP.Kind			= WEAPON_EQUIP1
SWEP.CanBuy			= {ROLE_TRAITOR}
SWEP.LimitedStock	= true
SWEP.AllowDrop		= false
SWEP.Icon			= "VGUI/ttt/weapon_ttt_breachingcharge"
SWEP.EquipMenuData	= {
   type = "Weapon",
   desc = "You can plant explosives on surfaces and people.\nPrimary fire to detonate.\nSecondary fire to plant.\nReload to drop."
}
if SERVER and engine.ActiveGamemode() == "terrortown" then
   resource.AddFile("materials/VGUI/ttt/weapon_ttt_breachingcharge.vmt")
end
AddCSLuaFile()
...
function SWEP:Equip(ply)
	if self.firstgiven == false then
		ply:GiveAmmo(1,"ammo_breachingcharge")
