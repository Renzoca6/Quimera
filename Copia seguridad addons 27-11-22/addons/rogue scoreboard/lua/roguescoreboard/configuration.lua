...
-- Server title
Configuration.ServerTitle           = "Quimera | Serius RP | CWRP"
...
-- Type your administrador prefix. Currently supports: "ulx", "serverguard", "xadmin2", "xadmin", "fadmin", "sam" 
...
Configuration.InformationView       = { "Moderator", "administrador", "superadmin", "e-m", "owner"}
...
Configuration.ReportURL             = "https://discord.gg/Stz5PQhKHd"


-- Report button administrador message if you are not using a report addon
Configuration.ReportPrefix          = "@"
Configuration.ReportedText          = "Me gustaría reportar"
...
-- Information bar
Configuration.NameText              = "NOMBRE" 
Configuration.JobText               = "REGIMIENTO" 
Configuration.KillsText             = "K" 
Configuration.DeathsText            = "M"

-- Button text
Configuration.ClearPropText         = "Limpiar props"
Configuration.MuteText              = "Silenciar"
Configuration.UnMuteText            = "Habilitar"
Configuration.ReportText            = "Reportar"

-- Command text
Configuration.TargetSelfCheck       = "No puedes seleccionarte a ti mismo.."
Configuration.CommandCopy           = "Copiar SteamID & SteamID64"
Configuration.CommandGoto           = "Ir"
Configuration.CommandBring          = "Traer"
Configuration.CommandSpectate       = "Spectar"
Configuration.CommandBringFreeze    = "Traer y congelar"

Configuration.CommandKick           = "EXPULSAR"
Configuration.CommandKickReason     = "Fuíste expulsado del servidor."

Configuration.CommandBan            = "BAN"
Configuration.CommandBanReason      = "Recibiste un baneo de dos horas."

Configuration.PropText              = "PROPS"

-- Incognito text
Configuration.ActivateIncog         = "VANISH"
Configuration.DeactivateIncog       = "DEACTIVATE"

-- Player count text
Configuration.CurrentPlayersText    = "Jugadores conectados"
...
Configuration.RankDisplay["superadmin"]     = { DisplayName = "C.E.O", TagName = "C.E.O", DisplayColor = Color( 255,155,0 ), TagColor = Color( 121,122,123 ) }
Configuration.RankDisplay["administrador"]  = { DisplayName = "Administrador", TagName = "Administrador", DisplayColor = Color( 255,255,255 ), TagColor = Color( 121,122,123 ) }
Configuration.RankDisplay["Moderator"]      = { DisplayName = "Moderador", TagName = "Moderator", DisplayColor = Color( 255,255,255 ), TagColor = Color( 121,122,123 ) }
Configuration.RankDisplay["Event Master"]   = { DisplayName = "Event Master", TagName = "EVENT MASTER", DisplayColor = Color( 255,255,255 ), TagColor = Color( 121,122,123 ) }  
Configuration.RankDisplay["donador"]        = { DisplayName = "Donador", TagName = "DONADOR", DisplayColor = Color( 255,255,255 ), TagColor = Color( 121,122,123 ) }
Configuration.RankDisplay["vip1"]           = { DisplayName = "VIP Bronce", TagName = "VIP BRONCE", DisplayColor = Color( 255,255,255 ), TagColor = Color( 121,122,123 ) }
Configuration.RankDisplay["vip2"]           = { DisplayName = "VIP Plata", TagName = "VIP PLATA", DisplayColor = Color( 255,255,255 ), TagColor = Color( 121,122,123 ) }
Configuration.RankDisplay["vip3"]           = { DisplayName = "VIP Oro", TagName = "VIP ORO", DisplayColor = Color( 255,255,255 ), TagColor = Color( 121,122,123 ) }  
Configuration.RankDisplay["vip4"]           = { DisplayName = "VIP Galaxy", TagName = "VIP GALAXY", DisplayColor = Color( 255,155,0 ), TagColor = Color( 121,122,123 ) }
Configuration.RankDisplay["user"]           = { DisplayName = "Usuario", TagName = "USUARIO", DisplayColor = Color( 255,255,255 ), TagColor = Color( 121,122,123 ) }
...
Configuration.PropAccess            = { "administrador", "superadmin", "owner" }

-- Who can see the administrative buttons
Configuration.MenuAccess            = { "c", "administrador", "superadmin", "event-master" }
...
Configuration.AllowedGoto           =  { "Moderator", "administrador", "superadmin", "event-master" }
-- Who has access to bring
Configuration.AllowedBring          =  { "Moderator", "administrador", "superadmin", "event-master" }
-- Who has access to spectate
Configuration.AllowedSpectate       =  { "Moderator", "administrador", "superadmin", "event-master" }
-- Who has access to freeze
Configuration.AllowedFreeze         =  { "Moderator", "administrador", "superadmin", "event-master" }
-- Who has access to kick
Configuration.AllowedKick           = { "Moderator", "administrador", "superadmin", "Owner" }
-- Who has access to ban
Configuration.AllowedBan            = { "Moderator", "administrador", "superadmin", "Owner" }
...
Configuration.IncognitoAccess       = { "administrador", "superadmin", "Owner" }
-- Who can see who is incognito mode?
Configuration.IncognitoVision       = { "administrador", "superadmin", "Owner" }
