...
cfg:SetTitle("Quimera | Serius RP | CWRP")
...
cfg:AddTab({
	name = "Panel",
	desc = "Estadísticas del servidor",
...
cfg:AddTab({
	name = "Jobs",
	desc = "¡Entra a un regimiento!",
	panel = "F4Menu.Jobs",
	icon = "MsBaa8Y"
})
cfg:AddTab({
	name = "Items",
	desc = "Entidades y más",
	panel = "F4Menu.Items",
	icon = "HVnAVBY"
})
...
cfg:AddURL({
	name = "Discord",
	desc = "¡Entra a nuestro Discord!",
	tabName = "Discord oficial de la comunidad",
	url = "https://discord.gg/xNbqUNxKhX",
	icon = "vHESvbx"
})
cfg:AddWebsite({
	name = "Workshop",
	desc = "Colección de addons del servidor",
	url = "https://steamcommunity.com/sharedfiles/filedetails/?id=2563574748",
	icon = "jvjxAQK"
})
--[[ Standalone commands
cfg:AddTab({
    ...
    "phrases": {
        "dashboard": {
            "tabs": {
                "general": {
                    ...
                    "richestPlayer": {
                        "title": "Jugador más rico",
                        "economy": ":percentage:% de la economía"
                    }
                },
                "economy": {
                    "name": "Gráfico económico",
                    "noData": "Sin datos",
                    "days": [
                        "Hoy",
                        "Hace 1 día",
            ...
            "favouriteJobs": {
                "title": "Jobs favoritos",
                "none": "Sin trabajos favoritos"
            },
            "onlineStaff": {
        ...
        "jobs": {
            "top": {
                ...
                "sort": {
                    ...
                    "highestSalary": "Salario más alto",
                    "lowestSalary": "Salario más alto",
                    "mostPeople": "Más personas",
                    "leastPeople": "Menos personas"
                },
                "showRecentJobs": "Jobs recientes",
                "showFavouriteJobs": "Jobs favoritos"
            },
            "slideout": {
                "tabs": {
                ...
                "levelRequirement": "Nivel requerido: :level:",
                "donatorJob": "¡Job sólo de donadores!",
                "button": {
                    "become": "USAR",
                    "areThisJob": "YA ESTÁS EN ÉL",
                    "jobIsFull": "EL JOB ESTÁ AL MÁXIMO",
                    "customCheckFailed": "HUBO UN PROBLEMA",
                    "tooLowLevel": "NIVEL MUY BAJO"
                },
                "anHour": "/h"
            },
            "favouriteJobs": "Jobs favoritos",
        ...
        "items": {
            ...
            "top": {
                ...
                "showFavourite": "Mostrar favorito(s)"
            },
        ...
        "options": {
            "general": {
                ...
                "dropMoney": {
                    "name": "Lanzar dinero",
                    "desc": "Coloca una cantidad.",
                    "placeholder": "$1000"
                },
                "giveMoney": {
                    "name": "Dar dinero",
                    "desc": "Darás dinero a la persona que estás apuntando",
                    "placeholder": "$1000"
                },
                "changeName": {
                    "name": "Cambiar nombre",
                    "desc": "Cambia tu nombre en el servidor",
                    "placeholder": "Name"
                },
                "changeJobTitle": {
                    "name": "Título de job",
                    "desc": "Escribe tu nuevo título",
